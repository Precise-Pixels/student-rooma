...
class LandlordLoginSystem {
    ...
    static function createUser($email, $password, $name, $phone) {
        ...
        $sth = $dbh->prepare("INSERT INTO landlords (email, password, valid, validateRand, resetRand, name, phone, lastTransactionId, lastPaymentStatus, timestamp) value (:email, :password, 0, :rand1, :rand2, :name, :phone, 'null', 'null', :timestamp)");

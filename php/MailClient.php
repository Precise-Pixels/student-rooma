...
class MailClient {
    static function sendMsg($userId, $propertyId, $activityId) {
        ...
        $msg     = "<html><body>
                    ...
                    <p><a href='http://studentrooma.co.uk/app/admin/activity?propertyId=$propertyId&userId=$userId'>http://studentrooma.co.uk/admin/activity?propertyId=$propertyId&userId=$userId</a></p>

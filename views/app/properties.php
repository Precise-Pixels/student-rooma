            ...
            <?php foreach($properties as $key => $property): ?>
                <div class="property<?= ($key === 0 ? ' property--active' : ''); ?>" data-property-id="<?= $property->propertyId; ?>">
                    ...
                    <div class="padding">
                        ...
                        <a href="http://maps.google.com/maps?q=<?= $property->address; ?>" target="_blank" class="property-map"><div data-src="https://maps.googleapis.com/maps/api/staticmap?center=<?= $property->address . ', ' . $property->location; ?>&zoom=15&size=WIDTHxHEIGHT&maptype=roadmap&format=jpg&scale=2&markers=scale:2%7Cicon:http://studentrooma.co.uk/img/pin.png%7C<?= $property->address . ', ' . $property->location; ?>&key=AIzaSyCNlx7Q6EFJ2nlJfkAnMIsCm94fdSzaqf4"></div></a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
